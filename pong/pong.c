...
static void gpio_setup(void)
{
    ...
    gpio_mode_setup(GPIOA, GPIO_MODE_INPUT, GPIO_PUPD_NONE, HSO);
    
    /* Setup GPIO pin GPIO1 on GPIO port A for HSI. */
    gpio_mode_setup(GPIOA, GPIO_MODE_OUTPUT, GPIO_PUPD_NONE, HSI);
...
int main(void) 
{
    ...
    usart_setup();
    hsi_set();
    printf("This is my pong to your ping!\n");
